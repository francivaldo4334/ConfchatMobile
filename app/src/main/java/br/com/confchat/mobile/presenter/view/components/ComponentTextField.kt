...
fun ComponentTextField1(
    ...
    when(type){
        ...
        TextFieldType.ConfirmPassword ->{
            ConfirmPassword(value = value,onChange = onChange,onFocus = onFocus, isError = isError)
        }
        TextFieldType.Date ->{
...
private fun None(
    ...
    BasicTextField(
        ...
        textStyle = TextStyle(color = if(isError) MaterialTheme.colorScheme.error else Color.Unspecified.copy(0.5f)),
        decorationBox = {
            Card(
...
@Composable
private fun Email(value:String, onFocus:()->Unit,isError:Boolean,onChange:(String)->Unit) {
    TextFieldWithLable(
        onFocus = onFocus,
...
@Composable
private fun Login(value:String, onFocus:()->Unit,isError:Boolean,onChange:(String)->Unit) {
    TextFieldWithLable(
...
@Composable
private fun UserName(value:String, onFocus:()->Unit,isError:Boolean,onChange:(String)->Unit) {
    TextFieldWithLable(
...
@Composable
private fun Password(value:String, onFocus:()->Unit,isError:Boolean,onChange:(String)->Unit) {
    TextFieldWithLable(
...
@Composable
private fun ConfirmPassword(value:String, onFocus:()->Unit,isError: Boolean,onChange:(String)->Unit) {
    TextFieldWithLable(
